...
CREATE TABLE "WhatsAppQR" (
    ...
    CONSTRAINT "WhatsAppQR_pkey" PRIMARY KEY ("pkId")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "unique_id_per_session_id_1" ON "Chat"("sessionId", "id");

-- CreateIndex
CREATE INDEX "Contact_sessionId_idx" ON "Contact"("sessionId");

-- CreateIndex
CREATE UNIQUE INDEX "unique_id_per_session_id_2" ON "Contact"("sessionId", "id");

-- CreateIndex
CREATE INDEX "GroupMetadata_sessionId_idx" ON "GroupMetadata"("sessionId");

-- CreateIndex
CREATE UNIQUE INDEX "unique_id_per_session_id_3" ON "GroupMetadata"("sessionId", "id");
...
-- CreateIndex
CREATE UNIQUE INDEX "unique_id_per_session_id_4" ON "Session"("sessionId", "id");

-- CreateIndex
CREATE INDEX "WhatsAppQR_sessionId_idx" ON "WhatsAppQR"("sessionId");
